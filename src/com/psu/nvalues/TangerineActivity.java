...
public class TangerineActivity extends Activity implements OnClickListener{
	Button btn_menu;
	Button btn_exit;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tangerine);
        ...
        btn_menu= (Button)findViewById(R.id.btn_tangerine_menu);
        btn_menu.setOnClickListener(this);
        
        btn_exit= (Button)findViewById(R.id.btn_tangerine_exit);
        btn_exit.setOnClickListener(this); 
        

        String str_nutrition = " Tangerines of Serving Size 195g contain ," +
        		"Total Calories             103," +
        		"Total Fat                    1 g," +
        		"Folate                     39 mcg ," +
        		"Vitamin C                 69mg," +

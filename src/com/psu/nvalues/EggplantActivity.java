...
public class EggplantActivity extends Activity implements OnClickListener{
	Button btn_menu;
	Button btn_exit;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eggplant);
        ...
        btn_menu= (Button)findViewById(R.id.btn_eggplant_menu);
        btn_menu.setOnClickListener(this);
        
        btn_exit= (Button)findViewById(R.id.btn_eggplant_exit);
        btn_exit.setOnClickListener(this);        
 
        
        String str_nutrition = " Parmigiana Eggplant of Serving Size 1  or 532g contains,," +
        		"Total Calories             670," +
        		"Total Fat                    288," +
        		"Carbohydrate           75g," +
        		"Protein                 23g," +

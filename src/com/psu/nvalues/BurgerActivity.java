...
public class BurgerActivity extends Activity implements OnClickListener{
	Button btn_menu;
	Button btn_exit;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu= (Button)findViewById(R.id.btn_burger_menu);
        btn_menu.setOnClickListener(this);
        
        btn_exit= (Button)findViewById(R.id.btn_burger_exit);
        btn_exit.setOnClickListener(this);        
        
        
        String str_nutrition = " Quesadilla Burger of  Serving size 1 has ," +
        		"Total Calories             1240 , " +
        		"Total Fat                   927 ," +
        		"Sodium                  3530 mg ," +
        		"Protein                   77g , " +

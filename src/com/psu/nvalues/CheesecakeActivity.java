...
public class CheesecakeActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu= (Button)findViewById(R.id.btn_cake_menu);
        btn_menu.setOnClickListener(this);
        
        btn_exit= (Button)findViewById(R.id.btn_cake_exit);
        btn_exit.setOnClickListener(this);        
       
        String str_nutrition = "Cheese cake of Serving Size  80 g contains,," +
        		"Total Calories             257," +
        		"Total Fat                    162," +
        		"Carbohydrate           20g," +
        		"Protein                 4g," +

...
public class HelpActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu= (Button)findViewById(R.id.btn_help_menu);
        btn_menu.setOnClickListener(this);
        
        btn_exit= (Button)findViewById(R.id.btn_help_exit);
        btn_exit.setOnClickListener(this);        
        

        String str_nutrition = " To know about the nutrition values of a food item," +
        		" speak the Name of the Food Item after clicking the SPEAK button in main menu" +
        		" (or) SELECT The Food Item from the MENU list." +  "    "+
        		"To go the MENU Screen click the MENU button." +
        		"To Exit from the Application click the EXIT button."; 
